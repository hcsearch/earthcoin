...
bool CWallet::CreateTransaction(const vector<pair<CScript, int64> >& vecSend,
                                CWalletTx& wtxNew, CReserveKey& reservekey, int64& nFeeRet, std::string& strFailReason, std::string strTxComment, const CCoinControl* coinControl)
{
    int64 nValue = 0;
    ...
    // transaction comment
    wtxNew.strTxComment = strTxComment.substr(0, MAX_TX_COMMENT_LEN);
...
string CWallet::SendMoney(CScript scriptPubKey, int64 nValue, CWalletTx& wtxNew, std::string strTxComment, bool fAskFee)
{
...
string CWallet::SendMoneyToDestination(const CTxDestination& address, int64 nValue, CWalletTx& wtxNew, std::string strTxComment, bool fAskFee)
{
    // Check amount
    if (nValue <= 0)
